...
export const DownloadSection = () => {
  ...
  return (
    <section className="px-4 mx-auto">
      <div className="bg-[--surface-card] -mt-10 md:-mt-44 gap-2 mb-10 md:mb-12 p-4 px-4 flex mx-auto justify-center items-center rounded-full w-fit">
        <Image
      ...
      <div className="space-y-6">
        <div className="relative rounded-3xl overflow-hidden h-[550px] lg:h-[600px] w-full">
          ...
          <div className="relative z-10 p-6 sm:p-8 lg:p-10 h-full flex flex-col justify-between">
            <div className="flex flex-col sm:flex-row justify-between">
              <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-general-black mb-4 sm:mb-0 leading-normal">
                Download
                <br />
                The MyDébbo
                <br />
            ...
            <div className="flex items-end md:justify-between justify-center">
              ...
              <div className="bg-general-black rounded-lg p-1.5 sm:p-2 md:flex md:static absolute top-4 right-4">
        ...
        <div className="relative rounded-3xl overflow-hidden h-[500px] sm:h-[320px] lg:h-[600px] w-full">
          ...
          <div className="relative z-10 p-6 sm:p-8 lg:p-10 h-full flex items-end">
            <h1 className="hidden md:block sm:text-2xl lg:text-4xl font-bold text-general-black leading-tight">
              Closing
              <br />
              the gender
              <br />
            ...
            <h2 className="text-3xl md:hidden font-bold text-general-black leading-tight">
