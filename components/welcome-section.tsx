        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 items-center rounded-3xl overflow-hidden">
          <div className=" lg:p-12">
            ...
            <div className="space-y-4">
              <div className="bg-[--surface-card] rounded-lg px-4 py-3 font-semibold">
              ...
              <div className="bg-[--surface-card] rounded-lg px-3 py-2 font-semibold">
          ...
          <div className="relative h-[400px] lg:h-[600px]">
            ...
            <p className="absolute bottom-8 left-8 text-white text-lg max-w-sm z-10">
